...
<div></div>
<div><span style="font-size: small">The purpose of the event was to bring the research community together to articulate concrete problem areas for altmetrics.  Together, we worked with developers to seed</span><span style="font-size: small"> technical solutions and</span><span style="font-size: small"> raised awareness of the pressing need for expanded altmetrics tool development.</span></div>
<div></div>
